"""The blueconnectha_ble integration entities."""
...
class BLUECONNECTBLEEntity(Entity):
    """Base class for Blue Connect ble entities."""

    _attr_has_entity_name = True
    _attr_should_poll = False

    def __init__(self, data: BlueConnectBLEData) -> None:
